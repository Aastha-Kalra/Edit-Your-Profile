    ...
    <>
      <div className="bg-[#5453A4]  lg:h-full absolute lg:relative lg:rounded-2xl md:w-full 2xl:h-[300%] xl:h-[100%] lg:w-44 xl:w-36 w-[345px] h-[110px]  left-2 lg:left-0 top-[104px] lg:top-0">
        <div className="flex lg:flex-col flex-row justify-around lg:gap-16 2xl:gap-12 xl:gap-8 lg:p-8 items-center gap-0">
          ...
          <div className="">        
          <div
            className={`mb-8 lg:mb-0 w-36  flex justify-center items-center rounded-2xl drop-shadow-2xl ${active2 === true ? "md:bg-sky-500" : ""} `}
            onClick={() => {
              activeTwo();
            }}
          >
          ...
          <div
            className={`icon rounded-2xl w-36  flex justify-center items-center  ${active1 === true ? "md:bg-sky-500" : ""} `}
            onClick={() => {
              active();
            }}
          >
          ...
          <div className="">
          <div
            className={`mb-8 w-36 md:rounded-2xl rounded-full flex justify-center items-center  ${active3 === true ? "md:bg-sky-500" : ""} `}
            onClick={() => {
              activeThree();
            }}
          >
